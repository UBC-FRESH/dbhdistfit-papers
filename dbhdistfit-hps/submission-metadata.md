# Discover Forests Submission Metadata (Transfer)

| Field | Value |
| --- | --- |
| Journal | *Discover Forests* |
| Article type | Brief Report |
| Manuscript title | *A Weighted Fitting Approach for Diameter Distributions from Horizontal Point Sampling* |
...
- Manuscript file: `dbhdistfit-hps/manuscript/main.tex` (includes Statements and Declarations + Data Availability).
- Title page: `dbhdistfit-hps/manuscript/title-page.tex` (author/affiliation/ORCID/keywords/word counts).
- Cover letter: `dbhdistfit-hps/manuscript/cover-letter.txt` and `.tex` updated for Discover Forests transfer.
- Data availability statement is mandatory per Discover Forests guidelines and is already included in the manuscript.
