...
Empirical diagnostics reinforce these advantages: across all species group and
cover type combinations examined, the weighted estimator tracks the
size-biased control within 2.4\% of the $\ell_2$ norm in stand table space and
within 8.5\% in HPS tally space (Table~\ref{tab:comparison}). This “very good”
agreement ensures that the simplified workflow can replace the classical
approach with negligible loss of fidelity.
