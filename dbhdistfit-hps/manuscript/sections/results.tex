...
Although absolute RSS values are large on the native scale, relative L$_2$ errors stay below 8.5\% and parameter estimates matched to at least four decimal places across all meta-plots. The notebook `notebooks/hpsdistfit\_repro.ipynb` documents the full set of replicates and provides interactive diagnostics.
