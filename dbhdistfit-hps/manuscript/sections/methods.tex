...
We reproduced and updated the computational experiment using permanent sample
plot (PSP) data collected across Quebec \citep{gouvernement2019}. The PSP
inventory provides stem tallies for 30 meta-plots combining species groups and
cover types. The PSP tallies originate from
