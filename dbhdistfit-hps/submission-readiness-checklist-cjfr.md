## CJFR Submission Readiness Checklist (Draft)
...
2. Build `manuscript-cjfr` and verify line numbering/double-spacing.
3. Decide appendix placement (separate document vs supplement).
