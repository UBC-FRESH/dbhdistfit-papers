...
\begin{table}[htbp]
  ...
  Values shown are residual sum of squares (RSS) in native scale, relative $\ell_2$ norms (\%),
  and chi-square statistics. Species-group codes are sepm (SPFL: spruce-pine-fir-larch),
  bop (birch), and ers (maple); cover-type codes r, m, f denote softwood, mixedwood,
