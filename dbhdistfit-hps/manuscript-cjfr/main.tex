...
\hyperref[sec:appendix-equivalence]{Appendix} derives equivalence for non-linear
...
the \hyperref[sec:appendix-equivalence]{Appendix} codifies this equivalence and supports
...
% NOTE: CJFR appendices are submitted as separate documents; keep in-sync here until split out.
\appendix
\renewcommand{\thesection}{A}
\refstepcounter{section}
\section*{Appendix: Derivation of Equivalence Between Estimators}
